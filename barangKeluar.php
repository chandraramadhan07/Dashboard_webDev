...
$sql_total = "SELECT COUNT(*) as total_produk FROM produk_keluar";
...
$sql_view_keluar = "SELECT 
                  ...
                  FROM produk_keluar 
                  INNER JOIN produk 
                  ON produk_keluar.id_produk = produk.id_produk ORDER BY produk_keluar.id_keluar DESC LIMIT $limit_baris OFFSET $offset";
          ...
          <div class="container-fluid position-relative d-flex align-items-center">
            <div class="header d-flex align-items-center">
              ...
              <div class="header-nav">
                <p class="fs-4 m-0 fw-semibold" >Hello, Admin!</p>
